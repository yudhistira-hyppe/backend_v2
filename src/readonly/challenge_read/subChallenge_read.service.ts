...
export class SubChallengeReadService {
    ...
    async getListUserChallengeNew3V2(idchallenge: string, iduser: string, status: string, session: number) {
        var pipeline = [];
    ...
    async getListUserChallengekeduaNew3V2(idchallenge: string, iduser: string, status: string, session: number) {
        var pipeline = [];
