...
export class GetusercontentsService {
  ...
  async databasenew2(buy: string, report: string, iduser: Object, username: string, description: string, kepemilikan: any[], statusjual: any[], postType: any[], kategori: any[], startdate: string, enddate: string, startmount: number, endmount: number, descending: boolean, page: number, limit: number, popular: any) {
  ...
  async databasenew3(buy: string, report: string, iduser: Object, username: string, description: string, kepemilikan: any[], statusjual: any[], postType: any[], kategori: any[], hashtag: any[], startdate: string, enddate: string, startmount: number, endmount: number, descending: boolean, page: number, limit: number, popular: any) {
    ...
    var listmatchingorfilter = [];

    if (kepemilikan && kepemilikan !== undefined) {
      listmatchingorfilter.push(
            {
              kepemilikan: {
                $in: kepemilikan
              }
    ...
    if(listmatchingorfilter.length != parseInt('0'))
    {
      pipeline.push(
        {
          "$match":
          {
            "$and":listmatchingorfilter
          }
        }
      );
    }

    console.log(listmatchingorfilter);
