...
export class UserticketsService {
  ...
  async filterdatacount(search: string, assignto: string, sumber: any[], kategori: any[], level: any[], status: any[], startdate: string, enddate: string, iduser?: string, close?: any) {
