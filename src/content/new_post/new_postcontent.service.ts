...
import { CreatePostResponse, Messages } from './dto/create-newPost.dto';
...
export class NewPostContentService {
  ...
  //   // //Get userbasics
  //   // const data_userbasics = await this.userbasicnewService.findOne(email);
  ...
  // private async buildPost_(body: any, data_userbasics: Userbasic): Promise<newPosts> {
  //   //Current Date
  //   const currentDate = await this.utilService.getDateTimeString();
  ...
  //       let getUserauth = await this.userbasicnewService.findOneUsername(tagPeopleSplit[i].toString());
  ...
  //       let getUserauth = await this.userbasicnewService.findOneUsername(tagDescriptionSplit[i].toString());
  //       if (await this.utilService.ceckData(getUserauth)) {
