...
import { NewcontenteventsDto } from './dto/create-newcontentevents.dto';
import { Newcontentevents, NewcontenteventsDocument } from './schemas/newcontentevents.schema';

@Injectable()
export class NewcontenteventsService {
    constructor(
        @InjectModel(Newcontentevents.name, 'SERVER_FULL')
        private readonly NewcontenteventsModel: Model<NewcontenteventsDocument>,
    ) { }

    async create(
        NewcontenteventsDto: NewcontenteventsDto,
    ): Promise<Newcontentevents> {
        const createContenteventsDto = await this.NewcontenteventsModel.create(NewcontenteventsDto);
        return createContenteventsDto;
    }

    async createNew(
        data: Newcontentevents,
    ): Promise<Newcontentevents> {
        const createContenteventsDto = await this.NewcontenteventsModel.create(
            NewcontenteventsDto,
        );
        return createContenteventsDto;
    }

    async findAll(): Promise<Newcontentevents[]> {
        return this.NewcontenteventsModel.find().exec();
    }

    async findFollowing(email: String): Promise<Newcontentevents[]> {
        let query = this.NewcontenteventsModel.find();
    ...
    async findisLike(email: string, postID: string) {
        let query = this.NewcontenteventsModel.aggregate([
    ...
    async updateNoneActive(email: string) {
        this.NewcontenteventsModel.updateMany(
            {
                email: email,
            },
            {
    ...
    async getConteneventbyType(CreateGetcontenteventsDto_: CreateGetcontenteventsDto): Promise<Newcontentevents[]> {
        return this.NewcontenteventsModel.find({
    ...
    //   }
    async findAllCategory(CreateGetcontenteventsDto_: CreateGetcontenteventsDto): Promise<Newcontentevents> {
        return this.NewcontenteventsModel.findOne(CreateGetcontenteventsDto_).exec();
    }

    async findParentBySender(eventType: string, email: string, senderParty: string, flowIsDone: boolean): Promise<Newcontentevents> {
        return this.NewcontenteventsModel.findOne({ eventType: eventType, email: email, senderParty: senderParty, flowIsDone: flowIsDone }).exec();
    }

    async findParentByReceiver(eventType: string, receiverParty: string, email: string, flowIsDone: boolean): Promise<Newcontentevents> {
        return this.NewcontenteventsModel.findOne({ eventType: eventType, email: email, receiverParty: receiverParty, flowIsDone: flowIsDone }).exec();
    }

    async findSenderOrReceiverByPostID(postID: string, eventType: string, email: string, receiverParty: string): Promise<Newcontentevents> {
        return await this.NewcontenteventsModel.findOne({ postID: postID, eventType: eventType, email: email, receiverParty: receiverParty }).exec();
    }

    async findSenderOrReceiver(eventType: string, email: string, receiverParty: string): Promise<Newcontentevents> {
        return await this.NewcontenteventsModel.findOne(
            {
                $and:
                    [
                        { eventType: eventType },
    ...
    async findOne(email: string): Promise<Newcontentevents> {
        return this.NewcontenteventsModel.findOne({ email: email }).exec();
    }

    async delete(id: string) {
        const deletedCat = await this.NewcontenteventsModel.findByIdAndRemove({
            _id: id,
        }).exec();
        return deletedCat;
    }
    ...
    async UserActivityNow(date: Date): Promise<Object> {
        ...
        var GetCount = this.NewcontenteventsModel.aggregate([
            {
                $addFields: {
    ...
    async findcontent() {
        const query = await this.NewcontenteventsModel.aggregate([
    ...
    async ceckData(email: String, eventType: String, event: String, receiverParty: String, senderParty: String, postID: String, active?: boolean): Promise<Newcontentevents> {
        let query = this.NewcontenteventsModel.findOne();
        query.where('email', email);
    ...
    async findEventByEmail(email: string, postID: string[], eventInsight: string): Promise<Newcontentevents[]> {
        return this.NewcontenteventsModel.find().where('email', email).where('postID').in(postID).where('eventType', eventInsight).where('active', true).where('event', 'DONE').exec();
    }

    async updateUnlike(email: string, eventType: string, event: string, postID: string, active: boolean) {
        this.NewcontenteventsModel.updateOne(
            {
                email: email,
                eventType: eventType,
                postID: postID,
    ...
    async findkunjunganprofile(email: string, startdate: string, enddate: string) {
        ...
        const query = await this.NewcontenteventsModel.aggregate(pipeline);
        return query;
    }
    async detailkunjunganprofile(email: string, startdate: string, enddate: string) {
        ...
        let query = await this.NewcontenteventsModel.aggregate(pipeline);
        return query;
    }

    public buildQueryFollowing(profile: Userbasic, vis: string, stoday: string, skip: number, row: number) {
        return this.NewcontenteventsModel.aggregate(
    ...
    async countLikeBoost(postID: string, startdate: string, enddate: string) {
        ...
        var query = await this.NewcontenteventsModel.aggregate(
            [
                {
                    $match: {
                        postID: postID,
    ...
    async updatesalelike(postid: string) {
        let data = await this.NewcontenteventsModel.updateMany({ "postID": postid, "eventType": "LIKE", "event": "DONE", },
            {
                $set: {
                    "active": false
                }
    ...
    async updatesaleview(postid: string) {
        let data = await this.NewcontenteventsModel.updateMany({ "postID": postid, "eventType": "VIEW", "event": "DONE", },
            {
                $set: {
                    "active": false
                }
