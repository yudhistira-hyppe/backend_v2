...
export class CountriesService {
    ...
    constructor(
        @InjectModel(Countries.name) private readonly countriesModel: Model<CountriesDocument>,
      ) {}
     
      async create(CreateCountriesDto: CreateCountriesDto): Promise<Countries> {
        const createCountriesDto = await this.countriesModel.create(CreateCountriesDto);
