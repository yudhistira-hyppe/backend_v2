...
export class ReactionsService {
    ...
    constructor(
        @InjectModel(Reactions.name) private readonly ReactionsModel: Model<ReactionsDocument>,
      ) {}
     
      async create(CreateReactionsDto: CreateReactionsDto): Promise<Reactions> {
        const createReactionsDto = await this.ReactionsModel.create(CreateReactionsDto);
      ...
      async delete(id: string) {
        const deletedCat = await this.ReactionsModel
