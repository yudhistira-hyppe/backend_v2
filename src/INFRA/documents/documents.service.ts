...
export class DocumentsService {
    ...
    constructor(
        @InjectModel(Documents.name) private readonly documentsModel: Model<DocumentsDocument>,
      ) {}
     
      async create(CreateDocumentsDto: CreateDocumentsDto): Promise<Documents> {
        const createDocumentsDto = await this.documentsModel.create(CreateDocumentsDto);
