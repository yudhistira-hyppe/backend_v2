...
export class InterestsService {
    constructor(
        @InjectModel(Interests.name) private readonly interestsModel: Model<InterestsDocument>,
      ) {}
     
      async create(CreateInterestsDto: CreateInterestsDto): Promise<Interests> {
        const createInterestsDto = await this.interestsModel.create(CreateInterestsDto);
